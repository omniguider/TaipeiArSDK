...
function Marker(poiData) {
    ...
    */
    ...
    this.markerDrawable_idle = new AR.ImageDrawable(World.markerDrawable_idle, 1.2, {
        zOrder: 0,
        opacity: 1.0,
        /*
    ...
    this.markerDrawable_selected = new AR.ImageDrawable(World.markerDrawable_selected, 1.2, {
        zOrder: 0,
        opacity: 0.0,
        onClick: null
    });
